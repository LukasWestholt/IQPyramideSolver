...
if __name__ == "__main__":
    ...
    piece1 = Piece(Color.white, Form({GamePosition(0, 0), GamePosition(1, 0), GamePosition(0, 1)}))
    pieces.remove(piece1)
    piece2 = Piece(Color.orange, Form({GamePosition(0, 0), GamePosition(0, 1), GamePosition(1, 1), GamePosition(2, 1)}))
